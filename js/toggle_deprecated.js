...
message.innerHTML = "\t Deleted material still appears in the index. It is text that was relevant to the project but not relevant anymore. When shown, it is marked with red background";
